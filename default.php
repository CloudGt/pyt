...
<!DOCTYPE html>
	<html>
		<head>
			...
			<link rel="icon" href="https://www.hostmania.es/favicon.ico">
		</head>
		...
		<body>
			<div id="wrapper">
				<header>
					<h2>
						<img src="https://www.hostmania.es/images/mail-logo-es.png">
						<br>
						Tu cuenta <a href="http://<?=$this_domain?>"><?=$this_domain?></a><? foreach($dir_name as $dir => $name) : ?>
							...
							<?endif; ?>
						<? endforeach; ?>
					  ¡Enhorabuena, tu cuenta está activa!</h2>
					  <br><p>Ahora puedes usar el Administrador de Archivos en tu Panel de Control o Cliente FTP para subir tu web. Esto es el contendio por defecto que se muestra en tu carpeta public_html.</p>
				</header>				
				<ul id="list">
					<li class="header"><span class="name">nombre</span><span class="size">tamaño</span><span class="time">fecha de modificación</span></li>
			<!-- folders -->
			<? if($folder_list): ?>
		...
		<? endif; ?>
				...
				<p>
					<p><strong>¿Necesitas ayuda? Contacta con nosotros ahora mismo:</strong></p>
					- Abre un ticket: <a href="http://cpanel.hostmania.es" target="_blank">http://cpanel.hostmania.es</a><br>
					- Llámanos: <strong>901 001 871</strong><br>
					- Chatea con nosotros: <a href="https://www.hostmania.es" target="_blank">https://www.hostmania.es</a><br>
					- Mándanos un email: <strong>clientes@hostmania.es</strong><br>
					- Lee la página de Preguntas Frecuentes: <a href="https://www.hostmania.es/faq" target="_blank">https://www.hostmania.es/faq</a><br>
					- Entra en nuestra Página de Facebook: <a href="https://www.facebook.com/HostMania.es" target="_blank">https://www.facebook.com/HostMania.es</a><br>
					- Suscríbete a nuestro canal:<a href="https://www.youtube.com/channel/UCMaz6Nq6QLVK7WcyWEwD3Uw" target="_blank">https://www.youtube.com/channel/UCMaz6Nq6QLVK7WcyWEwD3Uw</a>
				</p>
			</div>
		</body>
	</html>